...
\begin{document}
        ...
        \begin{cloze}{1}
            Возмем \( \varepsilon = \frac{|a|}{2} > 0. \) Тогда по определению предела \[
                \begin{gathered}
                    ...
                    \begin{aligned}
                        &\implies |a| = |a - x_n + x_n| \leqslant |x - x_n| + |x_n| < \frac{|a|}{2} + |x_n| \\
   ...
   \end{note}
    ...
    \begin{note}{2a9c150676e64b28b32989c7bb381a61}
        ...
        \begin{cloze}{1}
            \( \{ y_n \} \) ограничена \( \implies \exists m, M \in \mathbb R \quad \forall n \quad m < y_n < M. \)
    ...
    \begin{note}{136d69a689a14768bf3886968976cd48}
        ...
        \begin{cloze}{1}
            ...
            Тогда из определения предела
            \begin{multline*}
                \forall E > 0 \quad \exists N \in \mathbb N \quad \forall n > N \quad x_n > \frac{E}{b} \implies x_n b < E \\
                \implies x_n y_n \leqslant x_n b < E \implies x_n y_n < E \\
                \overset{\!\!\text{\tiny def}}\implies x_n y_n \to -\infty.
            \end{multline*}
        \end{cloze}
    \end{note}
