...
\begin{note}{6f82b93d571d44e1a269d81a2e81f940}
    Пусть \({ X }\) и \({ Y }\) --- два частично упорядоченных множества.
    При задании естественного порядка на \({ X \times Y }\), какая из координат считается главенствующей?

    \begin{cloze}{1}
        Вторая (с элементами \({ Y }\).)
    \end{cloze}
\end{note}
...
\begin{note}{992bc6cda07d46c683eb8e4c46538e69}
    Как представить \({ (\mathbb Z \times \mathbb Z, \leqslant) }\) в виде суммы?

    \begin{cloze}{1}
        \({ \ldots + \mathbb Z + \mathbb Z + \mathbb Z + \ldots }\)
    \end{cloze}
\end{note}

\begin{note}{cf7ddd424cb247a89eb9529d690840ad}
    Как представить \({ (\mathbb N \times \mathbb Z, \leqslant) }\) в виде суммы?

    \begin{cloze}{1}
        \({ \ldots + \mathbb N + \mathbb N + \mathbb N + \ldots }\)
    \end{cloze}
\end{note}
