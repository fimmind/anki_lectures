...
\begin{note}{110d1d04fa2246daa69b785b7fd393fe}
    ...
    Отображение \({ f }\) называется \begin{icloze}{2}изоморфизмом,\end{icloze} если \begin{icloze}{1}оно сохраняет порядок.\end{icloze}
\end{note}
...
\begin{note}{007687446bf044fb8b2643fb03f6dcd9}
    Все частично упорядоченные множества разбиваются на классы изоморфных, называемых \begin{icloze}{1}порядковыми типами.\end{icloze}
\end{note}
...
\begin{note}{6e4e63c5d18f46dd9e164c78f193c40e}
    ...
    \begin{cloze}{1}
        В \({ \mathbb R }\) не максимального элемента.
    \end{cloze}
\end{note}
