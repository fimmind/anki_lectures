...
\begin{note}{2771feb8afd448049fd587b560e40ec9}
    Let \({ \varphi : G \to H }\) be a group homomorphism.
    If \begin{icloze}{2}\({ \varphi }\) is injective\end{icloze} then
    \[
...
\begin{note}{48b10b987faa4173afd091d11bce69f8}
    ...
    \begin{cloze}{1}
        Any \({ g \in G }\) may be expressed as \({ x^{-1} \sigma(x) }\) for some \({ x \in G }\).
    \end{cloze}
\end{note}
...
\begin{note}{47792a9d48b64045b05ea3dd789e8d12}
    ...
    \begin{cloze}{1}
        \({ \sigma : x \mapsto x^{-1} }\), which is a homomorphism if and only if the group is abelian.
    \end{cloze}
\end{note}
