...
\begin{note}{de72c6c8aeb345c6b825e47ed14d68d3}
    \begin{icloze}{2}The kernel\end{icloze} of an action of the group \({ G }\) on a set \({ A }\) is the same as \begin{icloze}{3}the kernel\end{icloze} of \begin{icloze}{1}the corresponding permutation representation.\end{icloze}
\end{note}
