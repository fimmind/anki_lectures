...
\begin{note}{a598671e743349d0b29c1cece6eba13a}
...
\begin{note}{be412ac105f54f449f2ce11b95fb8dd2}
    How is the Ratio test applied to non-positive series?

    \begin{cloze}{1}
        Take absolute values of the terms before applying.
    \end{cloze}
\end{note}

\begin{note}{06aeafd6ae474fddb38ceebeb6d5a01b}
    What do we conclude from the Ratio Test when it is applied to non-positive series (\({ r < 1 }\))?
...
\begin{note}{71c352c373334749879a0e4ffc0537fe}
    Does the Ratio Test let us conclude anything when it is applied to non-positive series and \({ r > 1 }\)?
...
\begin{note}{c5847b85b1a84d59a720f37f9f7fe718}
    How can the conditions in the Root Test be strengthened?

    \begin{cloze}{1}
        Replace the limit with a limit superior.
    \end{cloze}
\end{note}

\begin{note}{be412ac105f54f449f2ce11b95fb8dd2}
    How is the Root test applied to non-positive series?
...
\begin{note}{06aeafd6ae474fddb38ceebeb6d5a01b}
    What do we conclude from the Root Test when it is applied to non-positive series (\({ r < 1 }\))?
...
\begin{note}{71c352c373334749879a0e4ffc0537fe}
    Does the Root Test let us conclude anything when it is applied to non-positive series and \({ r > 1 }\)?
...
\begin{note}{ed63990568ac41ff9e0d1b7535e91d62}
    ...
    \begin{cloze}{1}
        The sum of partial sums multiplied by successive differences.
    \end{cloze}
\end{note}
...
\begin{note}{fbd64e1c82f047908a69529a47757a02}
    ...
    \begin{cloze}{1}
        A convergent series times a bounded sequence is convergent.
    \end{cloze}
\end{note}
...
\begin{note}{0f341db289494976a66d37a683abea82}
    ...
    \begin{cloze}{1}
        A series formed from two sequence's product.
    \end{cloze}
\end{note}
...
\begin{note}{f87a7596fb944f9e8998cb889ea120e9}
    ...
    \begin{cloze}{1}
        A ``bounded'' series times an infinitesimal sequence is convergent.
    \end{cloze}
\end{note}
...
\begin{note}{b33fdd1764a743b4a67ea1c97b9bc645}
...
\begin{note}{21bccd3d129444a78f1a7551b115e0d7}
    What's special about \({ \sum_n \cos n\alpha }\)?

    \begin{cloze}{1}
        It's partial sums are almost always bounded.
    \end{cloze}
\end{note}

\begin{note}{824d7b145a46460b920b7ed5dcfd5525}
    When are the partial sums of \({ \sum_n \cos n\alpha }\) bounded?
...
\begin{note}{139783d95a774d0291b62140512e4faa}
    How do the partial sums of \({ \sum_n \cos n\alpha }\) behave when \({ \alpha = 2\pi k }\)?

    \begin{cloze}{1}
        They are monotone and increasing.
    \end{cloze}
\end{note}

\begin{note}{99fd294384754a0984d883fbfe8b1248}
    How do the partial sums of \({ \sum_n \cos n\alpha }\) behave when \({ \alpha \neq 2\pi k }\)?
