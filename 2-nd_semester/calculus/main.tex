...
\begin{note}{42d735dd7d56418d8e5183c6c0447207}
    ...
    \begin{cloze}{1}
        Используя равномерную непрерывность \({ \gamma'_i }\) показать, что для любого \({ \varepsilon > 0 }\) найдётся такое разбиение, что
        \[
...
\begin{note}{a157e6a52b0e4e22a04e35a2b9981058}
    ...
    \begin{cloze}{1}
        Неравнество треугольника и оценка \({ \left\lVert \:\cdot\: \right\rVert }\) через \({ \displaystyle \max_i \left\lvert {\:\cdot\:}_i \right\rvert }\).
    \end{cloze}
\end{note}
