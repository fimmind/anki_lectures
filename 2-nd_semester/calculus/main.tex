...
\begin{note}{cfe92784a4e244ecb916f9627404f421}
    ...
    \begin{cloze}{1}
        Показать, что для любых \({ x < a < y }\) из \({ \langle A, B \rangle }\) выполняется критерий выпуклости из леммы о трёх хордах.
    \end{cloze}
\end{note}
...
\begin{note}{8b55ad03aaca4dfcb1ec7ce171dee0ce}
    ...
    \begin{cloze}{1}
        Показать, что для \({ x < y }\)
        \[
            f'(x) \leqslant \frac{f(y) - f(x)}{y - x} \leqslant f'(y)
        \]
    \end{cloze}
\end{note}
...
\begin{note}{b1782e215a3d4a948b9fbddfbaed55d3}
    ...
    \begin{cloze}{1}
        Выбрать произвольные \({ a < c < b }\) и применить теорему Лагранжа к \({ [a, c] }\) и \({ [c, b] }\).
    \end{cloze}
\end{note}
