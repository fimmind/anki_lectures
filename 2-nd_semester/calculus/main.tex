...
\begin{note}{5defd336f3aa4b4aa26b239431f04d17}
    \[
        \begin{gathered}
            ...
            \begin{icloze}{1}\frac{x}{2} \sqrt{a^2 \pm x^2} \pm \frac{a^2}{2} \ln\left\lvert x + \sqrt{x^2 \pm a^2} \right\rvert\end{icloze}
            + C \\
            (a > 0)
        \end{gathered}
    \]
...
\begin{note}{f6c10d5634604b8785e6d50a3b4179bb}
    Пусть \begin{icloze}{3}\({ y = \dfrac{ax + b}{cx + d} \in \mathbb R(x) }\),\: \({ p_1, p_2, \ldots, p_n \in \mathbb Q }\).\end{icloze}
    Тогда интеграл вида
    \[
...
\begin{note}{8b2c86d7991e4a2b91921581b1ef4490}
    ...
    Тогда \begin{icloze}{2}если \({ f }\) выпукла на \({ \langle A, B \rangle }\) и \({ \int_{a}^{b} \lambda = 1 }\),\end{icloze} то
    \begin{icloze}{1}
        \[
...
\begin{note}{402dc5f48e084c56acdbac1d8691cd46}
    ...
    \begin{cloze}{1}
        \({ \int_{a}^{b} \lambda \varphi \in (\inf \varphi, \sup \varphi) }\), а по теорема Вейерштрасса
        \[
            \inf \varphi, \sup \varphi \in \langle A, B \rangle.
        \]
    \end{cloze}
\end{note}

\begin{note}{69bcf26030d34b71839c245e2f0b80ca}
    Как в доказательстве неравенства Йенсена (случай \({ \varphi \neq const }\)) показать, что \({ \int_{a}^{b} \lambda \varphi \in (\inf \varphi, \sup \varphi) }\)?
...
\begin{note}{40347c04583b4c95b7cac9a0158ee490}
    ...
    Пусть \begin{icloze}{2}\({ \left\{ a_i \right\}, \left\{ b_i \right\}_{i = 1}^{n} \subset \mathbb R_+ }\),\: \({ p }\) и \({ q }\) --- сопряжённые показатели.\end{icloze}
    Тогда
    \begin{icloze}{1}
        \[
...
\begin{note}{97e460d86c3c4db6b2267d79218280cd}
    ...
    Пусть \begin{icloze}{2}\({ f, g \in C[a, b] }\),\: \({ p }\) и \({ q }\) --- сопряжённые показатели.\end{icloze} Тогда
    \begin{icloze}{1}
        \[
...
\begin{note}{72d317fe9af54aa4b717962551ba6ea0}
    ...
    Пусть \begin{icloze}{2}\({ \left\{ a_i \right\}, \left\{ b_i \right\}_{i = 1}^{n} \subset \mathbb R }\),\: \({ p \in (1, +\infty) }\).\end{icloze}
    Тогда
    \begin{icloze}{1}
        \[
...
\begin{note}{19e57ef490ac48889603d288b4d8edd5}
    ...
    Пусть \begin{icloze}{2}\({ f, g \in  C[a, b] }\), \({ p \geqslant  1 }\).\end{icloze} Тогда
    \begin{icloze}{1}
        \[
...
\begin{note}{435bbbcd954b4c8bb3be63c6b63acc2a}
    Пусть \({ -\infty < a < b \leqslant +\infty }\), \({ f \in \mathcal R_{loc}[a, b) }\).
    \[
        \int_{a}^{\to b} f \overset{\text{def}}= \begin{icloze}{1}\lim_{c \to b^{-}} \int_{a}^{c} f.\end{icloze}
    \]
\end{note}

\begin{note}{51919a133fa34a6b8ed5ed7ad5b76bac}
    Пусть \({ -\infty \leqslant a < b < +\infty }\), \({ f \in \mathcal R_{loc}(a, b] }\).
    \[
        \int_{\to a}^{b} f \overset{\text{def}}= \lim_{c \to a^{+}} \int_{c}^{b} f.
    \]
\end{note}

\begin{note}{ce5726096a9e4dfab405c99e8f84c09d}
    \begin{icloze}{1}
        Выражения
        \[
            \int_{a}^{\to b} f,\: \int_{\to  a}^{b} f
        \]
    \end{icloze}
    называются \begin{icloze}{2}несобственными интегралами.\end{icloze}
\end{note}
...
\begin{note}{e38aaa87d3a54ae0aa44b08a84229224}
    ...
    \]
    берутся \begin{icloze}{1}подстановкой \({ a \sin t = x }\) для \({ t \in [-\frac{\pi}{2}, \frac{\pi}{2}] }\).\end{icloze}
\end{note}
...
\begin{note}{9c734267d24143218a9ed85452b8fb67}
    ...
    \[
        \int \begin{icloze}{2}R(x, \sqrt{a^2  + x^2})\end{icloze}\: dx
    \]
    берутся \begin{icloze}{1}заменой \({ a \operatorname{sh} t = x }\) для \({ t \in \mathbb R }\).\end{icloze}
\end{note}
...
\begin{note}{8c5f51e8a73d4e3fbf734d43dd62b423}
    ...
    \]
    берутся \begin{icloze}{1}заменой \({ a \operatorname{ch} t = x }\) для \({ t \in \mathbb R_+ }\).\end{icloze}
\end{note}
...
\begin{note}{a6d2e564dd8246af81224496b8f276b0}
    При взятии интегралов вида
    \[
        \int R(\sin x, \cos x)\: dx
    \]
    для определённости полагают, что \begin{icloze}{1}\({ x \in (-\pi, \pi) }\).\end{icloze}
\end{note}
...
\begin{note}{bf05e9b25c6048dfa9423efbf5f38cad}
    При взятии интегралов вида
    \[
        \int \sin^{m} x \cdot \cos^{m} x\: dx, \quad n, m \in \mathbb Q
    \]
    для определённости полагают \begin{icloze}{1}\({ x \in  [-\frac{\pi}{2}, \frac{\pi}{2}] }\).\end{icloze}
\end{note}
