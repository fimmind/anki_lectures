...
\begin{note}{f0f631536a7f4b96b0398f89ecaf9118}
    ...
    \begin{cloze}{1}
        Представить \({ \int_{a}^{b} fg }\) как \({ \int_{a}^{b} F'g }\), где \({ F(x) = \int_{a}^{x} f }\).
    \end{cloze}
\end{note}
...
\begin{note}{8b2c86d7991e4a2b91921581b1ef4490}
    ...
    Пусть \begin{icloze}{3}\({ f }\) непрерывна на \({ \langle A, B \rangle }\), \({ \varphi : [a, b] \to \langle A, B \rangle }\) непрерывна и \({ \lambda : [a, b] \to [0, +\infty) }\).\end{icloze}
