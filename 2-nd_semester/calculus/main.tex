...
\begin{note}{337fddddf6d64dd38b5ced0cae2bbbf3}
    \[
        \int \begin{icloze}{2}\frac{1}{x^2 - 1}\end{icloze} \: dx = \begin{icloze}{1}-\frac{1}{2} \ln\left\lvert \frac{1+x}{1-x} \right\rvert + C\end{icloze}.
    \]
\end{note}
...
\begin{note}{e74d0b4a860a42b48e714d90e8c31d07}
    Пусть \({ F : [a, b] \to \mathbb R }\) --- сила, действующая на движущееся по числовой оси тело, зависящая только от его положения.
    Тогда \({ A_{F}([a, b]) = \int_{a}^{b} F }\).
...
\begin{note}{91dfb67ce1114f4c869663609fbe77f9}
    Пусть \({ f : E \subset \mathbb R^{n} \to \mathbb R^{m} }\),\: \({ a \in \operatorname{Int} E }\),\: \({ s \in \mathbb Z_+ }\).
...
\begin{note}{a64074374f28419bb6aa71df69d8347b}
    Пусть \({ \alpha \in \mathbb Z_+^{n} }\) --- мультииндекс.
    Тогда
    \[
...
\begin{note}{38ec4052d4b84d6c8f0e1c8a8cdd1d22}
...
\begin{note}{d808baf356294ea7a0300e5a4402d4ec}
