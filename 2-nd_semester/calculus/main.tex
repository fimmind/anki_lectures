...
\begin{note}{799638c4bc6f4c50bb965b8803d41eab}
    ...
    Тогда если \({ G }\) открыто в \({ \mathbb R^{n} }\) и \({ G \subset E }\), то \({ G \subset \operatorname{Int} E }\).
\end{note}
...
\begin{note}{ff7b125dc2ee4647b62cf48f1c0edc4c}
    Чем определение предела отображения \({ E \subset \mathbb R^{n} \to \mathbb R^{m} }\) по Коши принципиально отличается от такового для функций \({ E \subset \mathbb R \to \mathbb R }\)?
...
\begin{note}{21646334c02042498ac8c3104a6f0b24}
    Чем определение предела отображения \({ E \subset \mathbb R^{n} \to \mathbb R^{m} }\) по Гейне принципиально отличается от такового для функций \({ E \subset \mathbb R \to \mathbb R }\)?
