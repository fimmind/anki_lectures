...
\begin{note}{c6f5af39f62e4d7f9a4cee9e0c45d107}
    \[
        \begin{gathered}
            ...
            \frac{x}{2} \sqrt{\begin{icloze}{1}x^2 \pm a^2\end{icloze}} \pm \frac{a^2}{2} \ln\left\lvert x + \sqrt{x^2 \pm a^2} \right\rvert
            + C \\
            (a > 0)
        \end{gathered}
    \]
...
\begin{note}{d7845b70c0774392b73e28626dab39f8}
    Пусть \begin{icloze}{3}\({ f \in C[\alpha, \beta] }\), \({ f \geqslant 0 }\).\end{icloze}
