...
\begin{note}{7a4501cbb6414feaaf12589452716ae3}
    ...
    \begin{cloze}{1}
        ...
        \]
        Далее по критерию интегрируемости.
    \end{cloze}
\end{note}
...
\begin{note}{ccba27d6a29c468f8a60fbd0f106fec4}
    Пусть \begin{icloze}{3}\({ f : [a, b] \to \mathbb R }\).\end{icloze} Функция \({ f }\) называется \begin{icloze}{2}кусочно непрерывной,\end{icloze} если \begin{icloze}{1}множество её точек разрыва пусто или конечно, и все её разрывы суть разрывы второго рода.\end{icloze}
\end{note}
...
\begin{note}{6bb4953a2e6d41fb86cf8a801779a97f}
    Пусть \({ f, g \in \mathcal R[a, b] }\). Тогда если \({ \underset{x \in [a, b]}{\inf} \left\lvert g(x) \right\rvert > 0 }\), то \({ \frac{f}{g} \in \mathcal R[a, b] }\).
