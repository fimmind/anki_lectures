...
\begin{note}{72d317fe9af54aa4b717962551ba6ea0}
    ...
    Пусть \begin{icloze}{2}\({ \left\{ a_i \right\}, \left\{ b_i \right\}_{i = 1}^{n} \subset \mathbb R }\),\end{icloze}\: \begin{icloze}{4}\({ p \in (1, +\infty) }\).\end{icloze}
    Тогда
    \begin{icloze}{1}
        \[
...
\begin{note}{1e256a23b0234f618630bb0ecd81a5c1}
    ...
    \begin{cloze}{1}
        Критерий Больцано-Коши сходимости функции для
        \[
            x \mapsto \int_{a}^{x} \left\lvert f \right\rvert.
        \]
    \end{cloze}
\end{note}
...
\begin{note}{591160f41fd4454bafe7bb81051e9799}
    Два пути \({ \gamma_1 : [a, b] \to \mathbb R^{m},\: \gamma_2 : [\alpha, \beta] \to \mathbb R^{m} }\) называются \begin{icloze}{2}эквивалентными,\end{icloze} если \begin{icloze}{1}существует строго возрастающая сюръекция \({ u : [a, b] \to [\alpha, \beta] }\) такая, что \({ \gamma_1 = \gamma_2 \circ u }\).\end{icloze}
\end{note}
...
\begin{note}{7b57ff51f8f74d7a9e4b6bc05043f32c}
    ...
    Множество
    \[
        \Big\{ \begin{icloze}{1}(r \cos \varphi, r \sin \varphi)\end{icloze} \mid \begin{icloze}{2}\varphi \in [\alpha, \beta],\: r \in [0, f(\varphi)]\end{icloze} \Big\}
    \]
    называется \begin{icloze}{3}криволинейным сектором.\end{icloze}
\end{note}
...
\begin{note}{37ce05b3e5534f20b8ea802974f37e7d}
    Пусть \begin{icloze}{4}\({ f : [\alpha, \beta] \to \mathbb R_+ }\),\end{icloze}\: \begin{icloze}{3}\({ -\frac{\pi}{2} \leqslant \alpha < \beta \leqslant \frac{\pi}{2} }\).\end{icloze}
...
\begin{note}{081bd87639824313a4c4b6ea6161ff62}
    ...
    Тогда
    \[
        \begin{icloze}{2}\gamma'\end{icloze} \overset{\text{def}}= \begin{icloze}{1}(\gamma'_m, \ldots, \gamma'_m).\end{icloze}
    \]
\end{note}
...
\begin{note}{d7845b70c0774392b73e28626dab39f8}
    Пусть \begin{icloze}{3}\({ f \in C^{1}[\alpha, \beta] }\), \({ f \geqslant 0 }\).\end{icloze}
    ...
    \[
        \gamma(\theta) = \begin{icloze}{1}(f(\theta) \cos \theta, f(\theta) \sin \theta), \quad \theta \in [\alpha, \beta].\end{icloze}
    \]
\end{note}
...
\begin{note}{82049479525249098f11edd6b86662f5}
    ...
    \[
        \mathbb R^{n} \to \mathbb R_+, \quad x \mapsto \sqrt{\sum_{i=1}^{n} x_i^2}.
    \]\end{icloze}
\end{note}
...
\begin{note}{2a6f33f0df8d4fd78ba6c02bccbc4f26}
    Пусть \({ \delta > 0 }\). Тогда \begin{icloze}{2}\({ \delta }\)-окрестность бесконечно удалённой точки в \({ \mathbb R^{n} }\)\end{icloze} обозначается \begin{icloze}{1}\({ V_{\delta}(\infty) }\).\end{icloze}
\end{note}
...
\begin{note}{435eee779e914a3b8c6aaa95f6a763e7}
    Пусть \({ \left\{ x^{k} \right\}_{k = 1}^{\infty} \subset \mathbb R^{n} }\),\: \begin{icloze}{4}\({ a \in \mathbb R^{n} }\).\end{icloze}
    Тогда \begin{icloze}{2}\({ \displaystyle \lim_{k \to \infty} x^{k} = a }\)\end{icloze} \begin{icloze}{3}тогда и только тогда\end{icloze} \({ \forall i \in [1 : n] }\) имеем
    \begin{icloze}{1}
        \[
...
\begin{note}{3fa906784d584b6e8ffd965de8a6322d}
    ...
    \begin{cloze}{1}
        Использовать неравенство \({ \left\lvert y_k \right\rvert \leqslant \left\lVert y \right\rVert }\) для вектора
        \[
            y = x^{k} - a.
        \]
    \end{cloze}
...
\begin{note}{7ac0f2188c6d4b72996dba94ed321553}
    ...
    \begin{cloze}{1}
        Использовать ограниченность координатных последовательностей \({ \left\{ x_i^{k} \right\} }\).
    \end{cloze}
\end{note}
...
\begin{note}{f4a0b38770684084b9485851c73d7764}
    ...
    \begin{cloze}{1}
        Использовать неограниченность вещественной последовательности \({ \left\{ \lVert x^{k} \rVert \right\} }\).
    \end{cloze}
\end{note}
