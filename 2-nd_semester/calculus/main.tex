...
\begin{note}{938420b690a6454bb2d2f1eea1281a1b}
    Пусть \({ f : [a, b] \to \mathbb R }\).
    Подграфик функции \({ f }\) называется \begin{icloze}{2}криволинейной трапецией,\end{icloze} если \begin{icloze}{1}\({ f \geqslant 0,\: f \in C[a, b] }\).\end{icloze}
\end{note}
...
\begin{note}{8e9b6c0f033b44bc81a2f3d4bf467a83}
    ...
    \begin{itemize}
        \item{} \begin{icloze}{1}\({ \exists [a, b] \subset \mathbb R \quad \forall x \not\in [a, b] \quad T(x) = \emptyset }\);\end{icloze}
