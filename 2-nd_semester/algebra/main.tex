...
\begin{note}{78106143b649485eb1c075b2388eb22e}
    ...
    Тогда
    \begin{center}
        \begin{icloze}{2}\( \chi_{f|_V} (\lambda) \)\end{icloze} --- \begin{icloze}{1}делитель \( \chi_f (\lambda) \).\end{icloze}
    \end{center}
\end{note}
...
\begin{note}{6deeef304fd8465bbff331e4241bde67}
    ...
    Тогда
    \begin{center}
        \( \chi_{f|_V} (\lambda) \) --- делитель \( \chi_f (\lambda) \).
    \end{center}

    В чем основная идея доказательства?

    \begin{cloze}{1}
        Показать, что \( \chi_f (\lambda) \) --- определитель соответствующей квазитреугольной матрицы оператора \( f \).
    \end{cloze}
\end{note}
...
\begin{note}{8066b576097a49fb9d5aa3c4580a27c5}
    ...
    Если а базисе \( e_1, e_2, \ldots, e_n \) матрица оператора \( f \) равна \( \operatorname{diag} (a_1, a_2, \ldots, a_n) \), то \begin{icloze}{2}\( e_1, e_2, \ldots, e_n \)\end{icloze} --- \begin{icloze}{1}собственные векторы \( f \).\end{icloze}
\end{note}

\begin{note}{19e6a7fb9c8e4f04a3711d479f2c628e}
    Пусть \( f : V \to V \)--- линейный оператор.
    Если а базисе \( e_1, e_2, \ldots, e_n \) матрица оператора \( f \) равна \( \operatorname{diag} (a_1, a_2, \ldots, a_n) \), то \begin{icloze}{2}\( a_1, a_2, \ldots, a_n \)\end{icloze} --- \begin{icloze}{1}собственные значения \( f \).\end{icloze}
\end{note}
...
\begin{note}{0fc84832f2b548cfa9a4ef9a51326b77}
    Пусть \( f : V \to V \) --- линейный оператор, \begin{icloze}{3}\( \lambda_1, \ldots, \lambda_n \) --- различные собственные значения оператора \( f \),\end{icloze} \begin{icloze}{2}\( \forall j \: v_j \in V_f (\lambda_j) \).\end{icloze}
...
\begin{note}{2a1e5294e5c34d889ca747ab0b44fa0a}
    Пусть \( f : V \to V \) --- линейный оператор, \( \lambda_1, \ldots, \lambda_n \) --- различные собственные значения оператора \( f \), \( \forall j \: v_j \in V_f (\lambda_j) \).
...
\begin{note}{b7cd455d24424dd0879b90d7cad89a6b}
    \begin{icloze}{3}Пусть пространство \( V = V_1 \oplus V_2 \).\end{icloze}
...
\begin{note}{5b16ae3e6ef643508aa2e1f086ffde51}
    Пусть \( f : V \to V \) --- линейный оператор.
    \begin{icloze}{1}Множество всех корневых векторов разных высот, отвечающих собственному значению \( \lambda \), объединённое с нулём,\end{icloze} называется \begin{icloze}{2}корневым подпространством, отвечающим собственному значению \( \lambda \).\end{icloze}
\end{note}
