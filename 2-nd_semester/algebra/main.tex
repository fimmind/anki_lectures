...
\begin{note}{69c2cd2726274e088ffcee35ddfc37af}
    Как называется основной алгоритм, который используется для построения жордановой нормальной формы линейного оператора?
