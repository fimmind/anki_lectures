...
\begin{note}{3450a4591ff748cb856f4578b3cda3c2}
    Пусть \({ p \in \mathbb C[x] }\),\: \({ A \in \mathbb C^{n \times n} }\). \begin{icloze}{1}Многочлен \( p \)\end{icloze} называется \begin{icloze}{2}аннулирующим многочленом для матрицы \( A \),\end{icloze} если \begin{icloze}{1}\( p(A) = 0 \).\end{icloze}
\end{note}
...
\begin{note}{25230410b91d47619feafd9dd1e3909e}
    ...
    Тогда \begin{icloze}{1}всегда существует ортогональный базис \({ a_1, \ldots, e_n }\) в \({ V }\) такой, что
    \[
...
\begin{note}{5e835ce387524f96b1feabc435dccbdc}
    Пусть \({ W }\) --- евклидово пространство, \({ V \triangleleft W }\).
    Как показать, что \({ V + V^{\perp} }\) --- прямая сумма?
...
\begin{note}{53d600a53a4f48a7b4d1e3a3822918fe}
    ...
    \begin{cloze}{1}
        Показать, что \({ \mathscr L (e_{k + 1}, \ldots, e_n) = V^{\perp} }\) по определению.
    \end{cloze}
\end{note}
