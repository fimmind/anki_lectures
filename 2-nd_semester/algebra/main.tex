...
\begin{note}{1176411a2bf147348b94dd69b9bbad73}
    Пусть \begin{icloze}{5}\( f : V \to V \) --- линейный оператор.\end{icloze} Тогда оператор \( f \) \begin{icloze}{2}диагонализуем\end{icloze} \begin{icloze}{3}тогда и только тогда, когда\end{icloze} \begin{icloze}{2}для любого собственного значения \( \lambda \)
    \[
