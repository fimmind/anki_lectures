...
\begin{note}{b04c0920040847d0a5d99e72e1d5f32f}
    ...
    \begin{icloze}{2}Расстоянием от точки \({ f }\) по пространство \({ V }\)\end{icloze} называется \begin{icloze}{1}величина
    \[
...
\begin{note}{c3802fe76b8740e28ef0bb2ce4d4aca0}
    ...
    Угол между векторами \({ f }\) и \({ g }\) обозначается
    \[
        (\widehat{f, g}).
    \]
\end{note}
...
\begin{note}{24059676faa84badb5f0199c24f6f28b}
    ...
    \begin{cloze}{1}
        Сравнить для \({ g \in V }\) величины \({ \cos (\widehat{f, g}) }\)  и \({ \cos (\widehat{f_0, g}) }\).
    \end{cloze}
\end{note}
...
\begin{note}{a7e0867fc1bc4ede8b8c8baf077decb8}
    ...
    \[
        \begin{icloze}{2}\operatorname{vol}_{n} \Pi(a_1)\end{icloze} \overset{\text{def}}= \begin{icloze}{1}\left\lVert a_1 \right\rVert.\end{icloze}
    \]
\end{note}

\begin{note}{27fc106d10454b36acb1d4fdb4d5ebc6}
    Пусть \({ V }\) --- евклидово пространство, \begin{icloze}{3}\({ \left\{ a_j \right\}_{j = 1}^{n} \subset V }\), \({ n > 1 }\).\end{icloze}
    \begin{multline*}
...
\begin{note}{8803537671b2486285e407e1661e183c}
    ...
    Тогда
    \[
        \left( \operatorname{vol}_{n} \Pi(a_1, \ldots, a_{n - 1}) \right)^2 =  \det G(a_1, \ldots, a_n).
    \]
