...
\begin{note}{25230410b91d47619feafd9dd1e3909e}
    ...
    Пусть \begin{icloze}{2}\({ V }\) --- евклидово пространство,\end{icloze}\: \begin{icloze}{4}\({ e_1, \ldots, e_n }\) --- базис в пространстве \({ V }\).\end{icloze}
...
\begin{note}{cc78cd0e52934eaf89bbd0be8dd6df0c}
    Пусть \({ V }\) --- эрмитово пространство, \({ \left\{ e_j \right\}_{j = 1}^{n} \subset V }\).
    Тогда
    \[
...
\begin{note}{3dbcabf7585c41e590b7515d2294cb74}
    Пусть \({ f }\) --- ортогональный оператор,\: \begin{icloze}{4}\({ a + bi }\)\end{icloze} --- его \begin{icloze}{3}собственный вектор,\end{icloze} отвечающий \begin{icloze}{2}\({ \lambda \in \mathbb C \setminus \mathbb R }\).\end{icloze}
