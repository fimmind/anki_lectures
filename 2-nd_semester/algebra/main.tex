...
\begin{note}{4884039a91ca44c2a72e903879e0cb15}
    ...
    \begin{cloze}{1}
        Из этого следует, что \({ f }\) представляется соответствующей квазитреугольной матрицей.
    \end{cloze}
\end{note}
...
\begin{note}{6a3db890388d426ba9b6f47900bb8d01}
    ...
    \begin{cloze}{1}
        Любой оператор имеет комплексные собственные значения, но из самосопряжённости следует, что они действительны.
    \end{cloze}
\end{note}
...
\begin{note}{89e9f8ff95e74665b47de711b04ebf2e}
    ...
    Тогда и только тогда \begin{icloze}{1}\({ f^* = f^{-1} }\).\end{icloze}
...
\begin{note}{2ecb4d7e7be047b887fa8953465857cb}
    Пусть \({ f : V \to V }\) --- \begin{icloze}{2}унитарный оператор.\end{icloze}
    Тогда и только тогда \begin{icloze}{1}\({ f }\) переводит любой ортонормированный базис в ортонормированный базис.\end{icloze}
...
\begin{note}{3ddc6bb6b47d44c6900bc4593cea65ba}
    Пусть \({ f : V \to V }\) --- \begin{icloze}{2}унитарный оператор.\end{icloze}
    Тогда и только тогда \begin{icloze}{1}матрица \({ f }\) в ортонормированном базисе унитарна.\end{icloze}
...
\begin{note}{4af2a0956e564d7a8dcff91122d2862c}
    В процессе ортогонализации определитель Грама-Шмидта Грама \begin{icloze}{1}не меняется.\end{icloze}
\end{note}
...
\begin{note}{dd5abffedea24431af7beee39693bcb2}
    ...
    Тогда
    \[
        \operatorname{sgn} \left\lvert G(e_1, \ldots, e_n) \right\rvert = \begin{icloze}{1}\text{\({ 0 }\) или \({ 1 }\)}.\end{icloze}
    \]
\end{note}
