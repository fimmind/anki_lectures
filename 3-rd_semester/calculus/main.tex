...
\begin{note}{7045668d58db45ad9892a6b3813128fd}
    Пусть \({ f }\) периодична с периодом \({ 2\pi }\).
    \begin{icloze}{1}Разложение \({ f }\) по системе \({ \left\{ 1, \cos nx, \sin nx \right\} }\) с коэффициентами Фурье\end{icloze} называется \begin{icloze}{1}рядом Фурье функции \({ f }\).\end{icloze}
\end{note}
...
\begin{note}{9d03d5873804424896da3f6d23a32213}
    Каким видом условия является теорема Дирихле?
...
\begin{note}{730f19be667548e9b24c9ce33ea43784}
    ...
    \begin{cloze}{1}
        Для непрерывных и кусочно-гладких на отрезке длинной в период.
    \end{cloze}
\end{note}
...
\begin{note}{5c566e83fa0340c58eac557785785279}
    Что можно сказать о ряде Фурье непрерывной, кусочно гладкой (на отрезке длинной в период) периодической функции?
...
\begin{note}{aa0ff21a64b54ffd97cd4c26310596a9}
    Пусть периодическая функция \({ f }\) имеет непрерывные производные порядка вплоть до \({ N - 1 }\) и кусочно-непрерывную (на отрезке длинной в период) производную порядка \({ N }\).
...
\begin{note}{24eb28a514eb4fc2811401b3ee9164d8}
    ...
    \begin{cloze}{1}
        Имеющих непрерывные производные порядка вплоть до \({ N - 1 }\) и кусочно-непрерывную (на отрезке длинной в период) производную порядка \({ N }\).
    \end{cloze}
\end{note}

\begin{note}{4c6aad88a3934ce89326f70fa8fdbeb0}
    Пусть \({ f }\) периодична и \({ f^{(k)} }\) кусочно-гладка на отрезке длинной в период.
...
\begin{note}{9b59e17ad69d491e8297660c69a7f64c}
    ...
    \begin{cloze}{1}
        Имеющих кусочно-гладкую (на отрезке длинной в период) производную порядка \({ k-1 }\).
    \end{cloze}
\end{note}

\begin{note}{15a14a3394e24021a7a78a7cb85cf781}
    Пусть \({ f }\) периодична, \({ f^{(k-1)} }\) непрерывна и \({ f^{(k)} }\) кусочно-гладка на отрезке длинной в период.
    Что можно сказать о коэффициентах ряда Фурье \({ f }\)?
...
\begin{note}{e9cbe9cc647b4cf7b15c0476a89bb310}
    ...
    \begin{cloze}{1}
        Таких что \({ f^{(k-2)} }\) непрерывна и \({ f^{(k)} }\) кусочно-гладка (на отрезке длинной в период.)
    \end{cloze}
\end{note}
