...
\begin{note}{5054e224483f4cc28f2739f6fad9f517}
    ...
    \[
        \begin{icloze}{2}\left\lVert R \cap S \right\rVert\end{icloze} = \begin{icloze}{1}\left\lVert R \right\rVert \circ \left\lVert S \right\rVert.\end{icloze}
    \]
\end{note}
...
\begin{note}{3d8bf9b65a4b4898be5460faaaecab86}
    ...
    \begin{icloze}{2}Транзитивным\end{icloze} замыканием \({ R }\) называют \begin{icloze}{1}наименьшее транзитивное отношение на \({ X }\), включающее \({ R }\).\end{icloze}
\end{note}
...
\begin{note}{e7b56866ed8e4192a45f157195f949e4}
    Пусть \({ R \subseteq A \times A }\) --- бинарное отношение.
    \begin{icloze}{3}Транзитивным сокращением \({ R }\)\end{icloze} называется \begin{icloze}{2}минимальное отношение \({ R' }\) на \({ X }\)\end{icloze} такое, что \begin{icloze}{1}транзитивное замыкание \({ R' }\) совпадает с транзитивным замыканием \({ R }\).\end{icloze}
\end{note}
